...
function displayPics(){
  ...
  // because the variable assined to const, and a const use to declarate scopping to a code block and we cant use the const variable outside the block, like for loop, if statement and so on ..
  console.log(viewed);
